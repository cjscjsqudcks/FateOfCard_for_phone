...
public class ItemActivity extends AppCompatActivity {
    ImageButton play,allcard,addcard,glence,doublecard,allplayer,defence;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startbtn=(Button)findViewById(R.id.item_startbtn);
        gamebtn=(Button)findViewById(R.id.item_gamebtn);
